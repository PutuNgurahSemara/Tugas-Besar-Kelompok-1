...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Reports', href: '#' }, // Link parent jika ada
...
export default function PurchaseReport() {
    ...
    // Data untuk Line Chart - Daily Purchases
    const lineChartData = {
    ...
    // Data untuk Bar Chart - Supplier Purchases
    const barChartData = {
                            ...
                            <TableBody>
                                {purchases.data.length > 0 ? (
                                    purchases.data.map((purchase) => {
                                        // Konversi quantity dari string ke number
                                        const quantityNum = parseFloat(purchase.quantity) || 0;
                                        const totalPrice = purchase.cost_price * quantityNum;
